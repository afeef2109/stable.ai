  ...
  head: () => ({
    meta: [
      { title: "STABLE — Enterprise AI Reliability Infrastructure" },
      {
        name: "description",
        content:
          "Monitor, evaluate, and improve AI systems with real-time observability, reliability scoring, and production-grade insights.",
      },
      { property: "og:title", content: "STABLE — Enterprise AI Reliability Infrastructure" },
      {
        property: "og:description",
        content:
          "Production-grade observability, evaluation, and reliability scoring for modern AI systems.",
      },
    ],
  }),
