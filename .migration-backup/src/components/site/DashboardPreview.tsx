...
export function DashboardPreview() {
  ...
  return (
    <div className="glass-strong relative overflow-hidden rounded-2xl p-3 shadow-[0_40px_120px_-30px_rgba(249,115,22,0.35)]">
      ...
      <div className="grid gap-3 rounded-xl bg-background/60 p-4 md:grid-cols-12">
        {/* Sidebar */}
        ...
        <div className="md:col-span-10 space-y-3">
          ...
          <div className="grid grid-cols-2 gap-3 md:grid-cols-4">
            <Kpi icon={<Gauge className="h-3.5 w-3.5" />} label="Reliability score" value="94.6" suffix="/100" tint="orange" />
            <Kpi icon={<Activity className="h-3.5 w-3.5" />} label="Requests / min" value="12.4k" tint="default" />
            <Kpi icon={<Sparkles className="h-3.5 w-3.5" />} label="Eval pass rate" value="98.2%" tint="gold" />
            <Kpi icon={<AlertTriangle className="h-3.5 w-3.5" />} label="Open incidents" value="2" tint="default" />
          </div>
